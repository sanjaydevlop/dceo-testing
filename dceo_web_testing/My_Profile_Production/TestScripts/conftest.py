...
def setup(request):
    ...
    driver.get("https://stringer.braneenterprises.com//login")
...
def pytest_runtest_makereport(item):
    ...
    if report.when == 'call' or report.when == "setup":
        ...
        if (report.skipped and xfail) or (report.failed and not xfail):
            ...
            if file_name:
                screenshot_path = f"{grandparent_dir}/My_Profile_Production/screenshots/{file_name}"
                screenshot_path_without_screenshot = f"{grandparent_dir}/My_Profile_Production"
