...
def setup(request):
    ...
    driver.get("https://testnhm.nslhub.com:7777/login")
...
def pytest_runtest_makereport(item):
    ...
    if report.when == 'call' or report.when == "setup":
        ...
        if (report.skipped and xfail) or (report.failed and not xfail):
            ...
            if file_name:
                screenshot_path = f"{grandparent_dir}/FeedbackHub/screenshots/{file_name}"
                screenshot_path_without_screenshot = f"{grandparent_dir}/FeedbackHub"
